...
class KMS {
  ...
  /// rotation of the key material</a> for the specified symmetric encryption
  /// KMS key.
  ///
  ...
  /// <a>DescribeKey</a> operation. You must also specify the length of the data
  /// key. Use either the <code>KeySpec</code> or <code>NumberOfBytes</code>
  ...
  /// useful in distributed systems with different levels of trust. For example,
